...
class Recommendation(Resource):
    ...
    def post(self):
        ...
        validCriteria = ['brand', 'nama', 'porsi', 'ukuran', 'sambel', 'hadiah', 'harga']
        ...
        recommendations = rumahmakan.get_recs(criteria)
        ranked_results = [{"nama": rumahmakan.rumahmakan_data_dict[rec[0]], "skor": rec[1], "peringkat": i + 1} for i, rec in enumerate(recommendations.items())]
